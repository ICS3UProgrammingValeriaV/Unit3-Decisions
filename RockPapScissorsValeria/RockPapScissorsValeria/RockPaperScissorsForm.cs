...
namespace RockPapScissorsValeria
{
    public partial class frmRockPaperScissors : Form
    {
        ...
        private void btnPlay_Click(object sender, EventArgs e)
        {
            ...
            if (playerChoice == ROCK)
            {
                ...
                else if (computerChoice == PAPER)
                {
                    ...
                    lblCompPoints.Text = "Points: " + Convert.ToString(pointsComp);
                }
                else if (computerChoice == SCISSORS)
                {
        ...
        {
            //if the radRockUser is clicked enable the button
            btnPlay.Enabled = true;
        }

        private void radPaperUser_CheckedChanged(object sender, EventArgs e)
        {
            //if the radPaperUser is clicked enable the button
            btnPlay.Enabled = true;
        }

        private void radScissorsUser_CheckedChanged(object sender, EventArgs e)
        {
            //if the radScissorsUser is clicked enable the button
            btnPlay.Enabled = true;
        }
    }
}
