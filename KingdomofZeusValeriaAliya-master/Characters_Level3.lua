...
-- -----------------------------------------------------------------------------------
 ...
 local function LevelDinoTransition()
    composer.gotoScene("level3Dino_screen", {effect = "fade", time = 300})
    audio.stop(1)
 end

 local function LevelZeusTransition()
    composer.gotoScene("level3Zeus_screen", {effect = "fade", time = 300})
    audio.stop(1)
 end
----------------------------------------------------------------------------------
...
function scene:create( event )
   ...
   ------------------------------------
   -- create the tv
   dino = widget.newButton(
     {
     --load the image files
     defaultFile = "CharactersSelect/level3Dino.png",
   ...
   sceneGroup:insert(dino)
    ...
    -- create the archer
   zeus = widget.newButton(
     {
     --load the image files
     defaultFile = "CharactersSelect/level3Zeus.png",
